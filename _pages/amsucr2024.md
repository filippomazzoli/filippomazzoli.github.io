...
Click anywhere on the title of a talk to see the abstract.

### Saturday, October 26

{% details 9-10 am, Room TBA: [Sara Maloni](https://sites.google.com/view/sara-maloni), **Dynamics on the $$\mathrm{SU}(2,1)$$-character varieties of the one-holed torus**. %}
...
{% details 10-10:30 am, Room TBA: [Zach Virgilio](https://mathdept.ucr.edu/people/zachary-virgilio), **Hyperbolic Structures arising from $$\mathrm{SU}(2,1)$$-Higgs bundles**. %}
...
{% details 10:30-11 am, Room TBA: [Stephen Mackes](https://sites.google.com/uic.edu/smacke5/home), **Local embeddedness criterion for equivariant pleated planes**. %}
...
{% details 8:30-9 am, Room TBA: [Parker Evans](https://sites.google.com/view/parker-evans/home), **Geometric Structures for the $$G_2'$$-Hitchin Component**. %}
...
{% details 9-9:30 am, Room TBA: Vicky Wen, **Sublinear Morseness in Higher Rank Symmetric space**. %}
...
{% details 9:30-10 am, Room TBA: [Teddy Weisman](https://websites.umich.edu/~tjwei/), **Dehn filling in semisimple Lie groups**. %}
...
{% details 10-10:30 am, Room TBA: [Fernando Al Assal](https://alassal.github.io/site/index.html), **Asymptotically geodesic surfaces in hyperbolic 3-manifolds**. %}
...
{% details 10:30-11 am, Room TBA: [Neza Zager Korenjak](https://neznez.github.io/index.html), **Proper affine deformations of positive representations**. %}
